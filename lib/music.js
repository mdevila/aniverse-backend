...
async function getConversionStatus(videoId) {
  ...
  // Fallback: race multiple loader.to jobs, poll inline up to ~50s (Vercel 60s limit)
  try {
    ...
    // Poll all jobs inline — race for first success
    const intervals = [500, 500, 800, 1000, 1000, 1500, 2000, 2000, 2000, 2000, 2000, 2000, 2000, 2000, 2000, 2000, 2000, 2000, 2000, 2000];
    ...
    return { status: 'converting', progress: 0.5, downloadUrl: null };
  } catch {}
